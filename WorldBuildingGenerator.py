...
words = {
    ...
    'gendescription': [['You see', '@genlocation', '.'], ['You see', '@genlocation', '.', '@genadddescription'], ['On the horizon you see', '@genlocation', '.', '@genadddescription'], ['On the horizon you see', '@genlocation', '.'], ['There is', '@genlocation', '.', '@genadddescription']],
